...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'data-analyst', 'sales-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Customer', path: '/customers', entity: 'customer', service: AccessServiceEnum.PROJECT, icon: FiBox },
